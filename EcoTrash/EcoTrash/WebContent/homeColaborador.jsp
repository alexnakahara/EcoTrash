...
<html lang="pt-br">
  ...
  <body>
  	...
  	<h3>Bem vindo Colaborador <%=u.getNome()%></h3>
  	<p>Endereço: <%=u.getEndereco()%> <%=u.getEndNumero()%></p><br>
  	<p>Bairro:<%=u.getBairro()%></p><br>
  	<p>Cidade:<%=u.getCidade()%></p><br>
  	<p>Cep:<%=u.getCep()%></p><br>
  	<hr>
  	<center>
  	<h5>Seus Agendamentos Confirmados:</h5>
  	</center>
  	<p><%=a%></p><br>>
	<form action="ListarAgendamentos.do" method="get">
  <a href="agendamento.jsp"><button type="submit" class="btn btn-secondary btn-lg btn-block">Buscar Pedidos</button></a>
  </form>
	</div>
